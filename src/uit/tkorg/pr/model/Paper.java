 ...
 * Data: 
 * paper id, paperTitle, year, paper type, tfidfVector in keywords' tf-idf list (ir's hashmapvector), 
 * and the full feature vector of the paper (hashmapvector computed by 
 * combining other paper with weighting scheme linear or cosine or rpy).
 * - if the paper is paper to recommend: list<String> of citationList, referenceList (paper id).
 * - if the paper is paper of author: List<Paper> of citationList, referenceList (Paper object, this class object).
