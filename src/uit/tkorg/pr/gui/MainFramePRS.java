    ...
    private void evaluate_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_evaluate_ButtonActionPerformed
        if (step2) {
            if (!topRank_TextField.getText().isEmpty()) {
                ...
                for(String author:controller.authorsCB.keySet()){
                    System.err.println(controller.authorsCB.get(author).getGroundTruth());
                }
                for(String author:controller.authorsCB.keySet()){
                    System.err.println(controller.authorsCB.get(author).getRecommendationList());
                }
